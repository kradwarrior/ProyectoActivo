...
public interface RepositorioActivos extends CrudRepository<Activo, Integer>, Repository<Activo, Integer> {
	...
	public List<Activo> findAllFiltro(@Param("tipo") String tipo, @Param("fechaCompra") Date fechaCompra, @Param("serial") String serial);
	
	@Transactional
	@Modifying
	@Query("update Activo a set a.serial=:serial, a.fechaBaja=:fechaBaja where a.id=:id")
	public void actualizarActivo(@Param("id") Integer id, @Param("serial") String serial, @Param("fechaBaja") Date fechaBaja);
